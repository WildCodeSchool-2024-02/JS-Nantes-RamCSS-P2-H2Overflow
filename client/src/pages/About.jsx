        ...
        <div className="text-container">
          <div className="text-element">
            ...
            <p>
              ...
              Michaël et Pascal. Cette application web a été créée dans le cadre
              le projet 2 de notre formation à la Wild Code School. L'objectif
              de ce projet était de créer une application web utilisant la
              bibliothèque Javascript "React", ainsi qu'une API.
            </p>
            ...
            public."
              ...
              à destination des ré utilisateurs, qu'il s'agisse de développeurs
              web ou mobiles, de bureaux d'études, de services publics, de
              collectivités, d'entreprises, ...
              <br />
